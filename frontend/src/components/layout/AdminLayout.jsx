...
const AdminLayout = () => {
  ...
  const menuItems = [
    ...
    { label: 'Gestion Animaux', path: '/admin/animaux' },
    { label: 'Adoptions', path: '/admin/adoptions' },
    { label: 'Toilettage', path: '/admin/toilettage' },
    { label: 'Couplage', path: '/admin/couplage' },
  ];
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 text-text-main">
      ...
      <div className="flex flex-1">
        ...
        >
          <div>
            <div className="font-serif text-lg md:text-xl font-bold text-primary">Admin Panel</div>
          ...
          <div className="mt-auto pt-6 border-t border-gray-200">
            <p className="text-xs text-muted mb-3">Version 1.0</p>
          </div>
        </aside>
