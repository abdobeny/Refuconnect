...
const Button = ({ children, variant = 'primary', className, disabled, ...props }) => {
  ...
  const variants = {
    primary: "bg-primary text-white hover:bg-[#5A9F4F] active:bg-primary disabled:hover:bg-primary",
    outline: "border-2 border-primary text-primary hover:bg-[#5A9F4F] hover:text-white active:bg-primary",
